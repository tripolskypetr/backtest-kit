...
### __@WAIT_FOR_INIT_SYMBOL@4169

```ts
__@WAIT_FOR_INIT_SYMBOL@4169: (() => Promise<void>) & ISingleshotClearable<() => Promise<void>>
```
...
### __@WRITE_SAFE_SYMBOL@4170

```ts
__@WRITE_SAFE_SYMBOL@4170: IWrappedQueuedFn<symbol | void, [line: string]>
```
