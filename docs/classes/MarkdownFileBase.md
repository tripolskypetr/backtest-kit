...
### __@WAIT_FOR_INIT_SYMBOL@1916

```ts
__@WAIT_FOR_INIT_SYMBOL@1916: (() => Promise<void>) & ISingleshotClearable
```
...
### __@WRITE_SAFE_SYMBOL@1917

```ts
__@WRITE_SAFE_SYMBOL@1917: (line: string) => Promise<symbol | void>
```
