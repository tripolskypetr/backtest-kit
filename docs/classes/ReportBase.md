...
### __@WAIT_FOR_INIT_SYMBOL@4600

```ts
__@WAIT_FOR_INIT_SYMBOL@4600: (() => Promise<void>) & ISingleshotClearable<() => Promise<void>>
```
...
### __@WRITE_SAFE_SYMBOL@4601

```ts
__@WRITE_SAFE_SYMBOL@4601: IWrappedQueuedFn<symbol | void, [line: string]>
```
