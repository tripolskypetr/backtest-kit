...
### __@WAIT_FOR_INIT_SYMBOL@1919

```ts
__@WAIT_FOR_INIT_SYMBOL@1919: (() => Promise<void>) & ISingleshotClearable
```
...
### __@WRITE_SAFE_SYMBOL@1920

```ts
__@WRITE_SAFE_SYMBOL@1920: (line: string) => Promise<symbol | void>
```
