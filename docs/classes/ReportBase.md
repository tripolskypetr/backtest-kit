...
### __@WAIT_FOR_INIT_SYMBOL@3059

```ts
__@WAIT_FOR_INIT_SYMBOL@3059: (() => Promise<void>) & ISingleshotClearable
```
...
### __@WRITE_SAFE_SYMBOL@3060

```ts
__@WRITE_SAFE_SYMBOL@3060: (line: string) => Promise<symbol | void>
```
