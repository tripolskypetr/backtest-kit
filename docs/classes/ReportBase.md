...
### __@WAIT_FOR_INIT_SYMBOL$1@2136

```ts
__@WAIT_FOR_INIT_SYMBOL$1@2136: (() => Promise<void>) & ISingleshotClearable
```
...
### __@WRITE_SAFE_SYMBOL$1@2137

```ts
__@WRITE_SAFE_SYMBOL$1@2137: (line: string) => Promise<symbol | void>
```
