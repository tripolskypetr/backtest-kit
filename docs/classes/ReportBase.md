...
### __@WAIT_FOR_INIT_SYMBOL$1@1858

```ts
__@WAIT_FOR_INIT_SYMBOL$1@1858: (() => Promise<void>) & ISingleshotClearable
```
...
### __@WRITE_SAFE_SYMBOL$1@1859

```ts
__@WRITE_SAFE_SYMBOL$1@1859: (line: string) => Promise<symbol | void>
```
