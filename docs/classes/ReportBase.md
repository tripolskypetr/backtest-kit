...
### __@WAIT_FOR_INIT_SYMBOL$1@1855

```ts
__@WAIT_FOR_INIT_SYMBOL$1@1855: (() => Promise<void>) & ISingleshotClearable
```
...
### __@WRITE_SAFE_SYMBOL$1@1856

```ts
__@WRITE_SAFE_SYMBOL$1@1856: (line: string) => Promise<symbol | void>
```
