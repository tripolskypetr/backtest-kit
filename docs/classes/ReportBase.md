...
### __@WAIT_FOR_INIT_SYMBOL$1@2164

```ts
__@WAIT_FOR_INIT_SYMBOL$1@2164: (() => Promise<void>) & ISingleshotClearable
```
...
### __@WRITE_SAFE_SYMBOL$1@2165

```ts
__@WRITE_SAFE_SYMBOL$1@2165: (line: string) => Promise<symbol | void>
```
