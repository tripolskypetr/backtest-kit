...
> **Закрыто 2026-07-03 решениями продукта** (см. TODO.md, пятый проход → «Решения продукта»): retry — вариант (а), откат `_lastSignalTimestamp`, реализовано; risk-reject-after-fill — adapter-side, задокументировано в `Broker.commitScheduleCancelled`.
