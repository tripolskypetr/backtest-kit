...
### __@WAIT_FOR_INIT_SYMBOL@4782

```ts
__@WAIT_FOR_INIT_SYMBOL@4782: (() => Promise<void>) & ISingleshotClearable<() => Promise<void>>
```
...
### __@WRITE_SAFE_SYMBOL@4783

```ts
__@WRITE_SAFE_SYMBOL@4783: IWrappedQueuedFn<symbol | void, [line: string]>
```
