...
### __@WAIT_FOR_INIT_SYMBOL@4640

```ts
__@WAIT_FOR_INIT_SYMBOL@4640: (() => Promise<void>) & ISingleshotClearable<() => Promise<void>>
```
...
### __@WRITE_SAFE_SYMBOL@4641

```ts
__@WRITE_SAFE_SYMBOL@4641: IWrappedQueuedFn<symbol | void, [line: string]>
```
