...
- Validation parameters (TP/SL distance constraints): [14.2](./76_Validation_Parameters.md)
- Timing parameters (signal lifetime and scheduling): [14.3](./77_Timing_Parameters.md)
