...
### __@WAIT_FOR_INIT_SYMBOL@2218

```ts
__@WAIT_FOR_INIT_SYMBOL@2218: (() => Promise<void>) & ISingleshotClearable
```
...
### __@WRITE_SAFE_SYMBOL@2219

```ts
__@WRITE_SAFE_SYMBOL@2219: (line: string) => Promise<symbol | void>
```
