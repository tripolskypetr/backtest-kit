...
### __@WAIT_FOR_INIT_SYMBOL@1861

```ts
__@WAIT_FOR_INIT_SYMBOL@1861: (() => Promise<void>) & ISingleshotClearable
```
...
### __@WRITE_SAFE_SYMBOL@1862

```ts
__@WRITE_SAFE_SYMBOL@1862: (line: string) => Promise<symbol | void>
```
