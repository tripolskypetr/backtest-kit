...
### __@WAIT_FOR_INIT_SYMBOL$1@1860

```ts
__@WAIT_FOR_INIT_SYMBOL$1@1860: (() => Promise<void>) & ISingleshotClearable
```
...
### __@WRITE_SAFE_SYMBOL$1@1861

```ts
__@WRITE_SAFE_SYMBOL$1@1861: (line: string) => Promise<symbol | void>
```
