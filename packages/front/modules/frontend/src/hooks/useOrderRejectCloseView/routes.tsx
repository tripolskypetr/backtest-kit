...
import OrderRejectCloseView from "./view/OrderRejectCloseView";
...
export const routes: IOutletModal[] = [
  {
    id: "order_reject_close",
    element: OrderRejectCloseView,
    isActive: (pathname) => hasMatch(["/order_reject_close"], pathname),
  },
  {
    id: "candle_1m",
