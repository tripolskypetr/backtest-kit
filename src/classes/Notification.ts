...
const CREATE_SIGNAL_NOTIFICATION_FN = (data: IStrategyTickResult): NotificationModel | null => {
  if (data.action === "opened") {
    return {
      ...
      worstStale: data.signal.worstStale,
      ...
      worstStaleGivebackPercentage: data.signal.worstStale.peakPnlPercentage - data.signal.worstStale.pnlPercentage,
      worstStaleMinutes: Math.floor((data.signal.worstStale.timestamp - data.signal.worstStale.peakTimestamp) / 60000),
...
const CREATE_PARTIAL_PROFIT_NOTIFICATION_FN = (data: PartialProfitContract): NotificationModel => ({
  ...
  worstStale: data.data.worstStale,
  ...
  worstStalePriceOpen: data.data.worstStale.priceOpen,
  worstStalePriceClose: data.data.worstStale.priceClose,
  worstStalePercentage: data.data.worstStale.pnlPercentage,
  worstStaleCost: data.data.worstStale.pnlCost,
  worstStaleEntries: data.data.worstStale.pnlEntries,
  worstStalePeakPercentage: data.data.worstStale.peakPnlPercentage,
  worstStaleGivebackPercentage: data.data.worstStale.peakPnlPercentage - data.data.worstStale.pnlPercentage,
  worstStaleMinutes: Math.floor((data.data.worstStale.timestamp - data.data.worstStale.peakTimestamp) / 60000),
  worstStaleBreakevenPrice: data.data.worstStale.breakevenPrice,
  worstStaleBreakevenTimestamp: data.data.worstStale.breakevenTimestamp,
  note: data.data.note,
