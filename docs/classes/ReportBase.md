...
### __@WAIT_FOR_INIT_SYMBOL@5243

```ts
__@WAIT_FOR_INIT_SYMBOL@5243: (() => Promise<void>) & ISingleshotClearable<() => Promise<void>>
```
...
### __@WRITE_SAFE_SYMBOL@5244

```ts
__@WRITE_SAFE_SYMBOL@5244: IWrappedQueuedFn<symbol | void, [line: string]>
```
