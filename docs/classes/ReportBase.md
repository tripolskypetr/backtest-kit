...
### __@WAIT_FOR_INIT_SYMBOL$1@1910

```ts
__@WAIT_FOR_INIT_SYMBOL$1@1910: (() => Promise<void>) & ISingleshotClearable
```
...
### __@WRITE_SAFE_SYMBOL$1@1911

```ts
__@WRITE_SAFE_SYMBOL$1@1911: (line: string) => Promise<symbol | void>
```
