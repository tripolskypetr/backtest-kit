...
### __@WAIT_FOR_INIT_SYMBOL@3006

```ts
__@WAIT_FOR_INIT_SYMBOL@3006: (() => Promise<void>) & ISingleshotClearable
```
...
### __@WRITE_SAFE_SYMBOL@3007

```ts
__@WRITE_SAFE_SYMBOL@3007: (line: string) => Promise<symbol | void>
```
