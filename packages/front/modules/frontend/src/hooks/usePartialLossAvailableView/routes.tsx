...
import PartialLossAvailableView from "./view/PartialLossAvailableView";
...
export const routes: IOutletModal[] = [
  {
    id: "partial_loss_available",
    element: PartialLossAvailableView,
    isActive: (pathname) => hasMatch(["/partial_loss_available"], pathname),
  },
  {
    id: "candle_1m",
