...
class HeatmapStorage {
  ...
  public async getReport(
    ...
    return [
      ...
      `**Avg Consecutive Win PNL Per Symbol:** ${data.portfolioAvgConsecutiveWinPnl !== null ? `${data.portfolioAvgConsecutiveWinPnl.toFixed(2)} %` : "N/A"}`,
      `**Avg Consecutive Loss PNL Per Symbol:** ${data.portfolioAvgConsecutiveLossPnl !== null ? `${data.portfolioAvgConsecutiveLossPnl.toFixed(2)} %` : "N/A"}`,
