...
export interface IClosePendingPayload {
  symbol: string;
  strategyName: string;
  exchangeName: string;
}
...
interface IParams {
  payload: {
    getContext: () => IClosePendingPayload;
    reloadSubject: TSubject<void>;
  };
}

export const useClosePendingModal = ({ payload }: IParams) => {
...
export default useClosePendingModal;
