...
### __@WAIT_FOR_INIT_SYMBOL@5636

```ts
__@WAIT_FOR_INIT_SYMBOL@5636: (() => Promise<void>) & ISingleshotClearable<() => Promise<void>>
```
...
### __@WRITE_SAFE_SYMBOL@5637

```ts
__@WRITE_SAFE_SYMBOL@5637: IWrappedQueuedFn<symbol | void, [line: string]>
```
