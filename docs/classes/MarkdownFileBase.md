...
### __@WAIT_FOR_INIT_SYMBOL@1975

```ts
__@WAIT_FOR_INIT_SYMBOL@1975: (() => Promise<void>) & ISingleshotClearable
```
...
### __@WRITE_SAFE_SYMBOL@1976

```ts
__@WRITE_SAFE_SYMBOL@1976: (line: string) => Promise<symbol | void>
```
