...
For information about signal states and transitions, see [Signal States](./47_Signal_States.md). For details on when PnL is calculated during signal closure, see [Signal Lifecycle](./46_Signal_Lifecycle.md).
