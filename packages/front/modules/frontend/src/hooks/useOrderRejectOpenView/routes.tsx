...
import OrderRejectOpenView from "./view/OrderRejectOpenView";
...
export const routes: IOutletModal[] = [
  {
    id: "order_reject_open",
    element: OrderRejectOpenView,
    isActive: (pathname) => hasMatch(["/order_reject_open"], pathname),
  },
  {
    id: "candle_1m",
