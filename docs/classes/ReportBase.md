...
### __@WAIT_FOR_INIT_SYMBOL@5667

```ts
__@WAIT_FOR_INIT_SYMBOL@5667: (() => Promise<void>) & ISingleshotClearable<() => Promise<void>>
```
...
### __@WRITE_SAFE_SYMBOL@5668

```ts
__@WRITE_SAFE_SYMBOL@5668: IWrappedQueuedFn<void | unique symbol, [line: string]>
```
