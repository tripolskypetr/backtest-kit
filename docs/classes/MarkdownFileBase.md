...
### __@WAIT_FOR_INIT_SYMBOL@3545

```ts
__@WAIT_FOR_INIT_SYMBOL@3545: (() => Promise<void>) & ISingleshotClearable
```
...
### __@WRITE_SAFE_SYMBOL@3546

```ts
__@WRITE_SAFE_SYMBOL@3546: (line: string) => Promise<symbol | void>
```
