...
### __@WAIT_FOR_INIT_SYMBOL@1917

```ts
__@WAIT_FOR_INIT_SYMBOL@1917: (() => Promise<void>) & ISingleshotClearable
```
...
### __@WRITE_SAFE_SYMBOL@1918

```ts
__@WRITE_SAFE_SYMBOL@1918: (line: string) => Promise<symbol | void>
```
