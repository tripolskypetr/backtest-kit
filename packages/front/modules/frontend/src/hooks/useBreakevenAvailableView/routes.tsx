...
import BreakevenAvailableView from "./view/BreakevenAvailableView";
...
export const routes: IOutletModal[] = [
  {
    id: "breakeven_available",
    element: BreakevenAvailableView,
    isActive: (pathname) => hasMatch(["/breakeven_available"], pathname),
  },
  {
    id: "candle_1m",
