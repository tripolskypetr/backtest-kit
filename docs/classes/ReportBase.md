...
### __@WAIT_FOR_INIT_SYMBOL$1@2153

```ts
__@WAIT_FOR_INIT_SYMBOL$1@2153: (() => Promise<void>) & ISingleshotClearable
```
...
### __@WRITE_SAFE_SYMBOL$1@2154

```ts
__@WRITE_SAFE_SYMBOL$1@2154: (line: string) => Promise<symbol | void>
```
