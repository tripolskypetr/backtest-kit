...
### __@WAIT_FOR_INIT_SYMBOL$1@1885

```ts
__@WAIT_FOR_INIT_SYMBOL$1@1885: (() => Promise<void>) & ISingleshotClearable
```
...
### __@WRITE_SAFE_SYMBOL$1@1886

```ts
__@WRITE_SAFE_SYMBOL$1@1886: (line: string) => Promise<symbol | void>
```
