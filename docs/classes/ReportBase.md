...
### __@WAIT_FOR_INIT_SYMBOL@4589

```ts
__@WAIT_FOR_INIT_SYMBOL@4589: (() => Promise<void>) & ISingleshotClearable<() => Promise<void>>
```
...
### __@WRITE_SAFE_SYMBOL@4590

```ts
__@WRITE_SAFE_SYMBOL@4590: IWrappedQueuedFn<symbol | void, [line: string]>
```
