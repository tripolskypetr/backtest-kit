...
### __@WAIT_FOR_INIT_SYMBOL$1@1773

```ts
__@WAIT_FOR_INIT_SYMBOL$1@1773: (() => Promise<void>) & ISingleshotClearable
```
...
### __@WRITE_SAFE_SYMBOL$1@1774

```ts
__@WRITE_SAFE_SYMBOL$1@1774: (line: string) => Promise<symbol | void>
```
