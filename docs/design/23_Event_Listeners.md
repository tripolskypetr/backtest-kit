...
For information about the underlying event system architecture and Subject-based pub-sub pattern, see [3.4](./14_Event_System.md). For details on signal lifecycle states that trigger events, see [8.1](./49_Signal_States.md). For execution mode differences in event emission, see [2.1](./06_Execution_Modes.md).
