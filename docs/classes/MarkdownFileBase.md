...
### __@WAIT_FOR_INIT_SYMBOL@1924

```ts
__@WAIT_FOR_INIT_SYMBOL@1924: (() => Promise<void>) & ISingleshotClearable
```
...
### __@WRITE_SAFE_SYMBOL@1925

```ts
__@WRITE_SAFE_SYMBOL@1925: (line: string) => Promise<symbol | void>
```
