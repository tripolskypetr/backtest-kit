...
import PartialProfitCommitView from "./view/PartialProfitCommitView";
...
export const routes: IOutletModal[] = [
  {
    id: "partial_profit_commit",
    element: PartialProfitCommitView,
    isActive: (pathname) => hasMatch(["/partial_profit_commit"], pathname),
  },
  {
    id: "candle_1m",
