...
const PRICE_REACTION_PROMPT = str.newline(
  ...
  ' - Стратегия — вход на опережение: входим до того, как рынок отреагировал на сентимент.',
  ' - **enter**: цена ещё не двигалась (not_priced_in) в направлении сентимента или находится в процессе (pricing_in) — есть потенциал для движения.',
  ' - **wait**: цена уже отреагировала (priced_in) — движение упущено.',
  '',
  '**Требуемый результат:**',
