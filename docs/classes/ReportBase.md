...
### __@WAIT_FOR_INIT_SYMBOL@3765

```ts
__@WAIT_FOR_INIT_SYMBOL@3765: (() => Promise<void>) & ISingleshotClearable<() => Promise<void>>
```
...
### __@WRITE_SAFE_SYMBOL@3766

```ts
__@WRITE_SAFE_SYMBOL@3766: (line: string) => Promise<symbol | void>
```
