...
### __@WAIT_FOR_INIT_SYMBOL@2881

```ts
__@WAIT_FOR_INIT_SYMBOL@2881: (() => Promise<void>) & ISingleshotClearable
```
...
### __@WRITE_SAFE_SYMBOL@2882

```ts
__@WRITE_SAFE_SYMBOL@2882: (line: string) => Promise<symbol | void>
```
