...
### __@WAIT_FOR_INIT_SYMBOL@3715

```ts
__@WAIT_FOR_INIT_SYMBOL@3715: (() => Promise<void>) & ISingleshotClearable<() => Promise<void>>
```
...
### __@WRITE_SAFE_SYMBOL@3716

```ts
__@WRITE_SAFE_SYMBOL@3716: (line: string) => Promise<symbol | void>
```
