...
### __@WAIT_FOR_INIT_SYMBOL@3759

```ts
__@WAIT_FOR_INIT_SYMBOL@3759: (() => Promise<void>) & ISingleshotClearable<() => Promise<void>>
```
...
### __@WRITE_SAFE_SYMBOL@3760

```ts
__@WRITE_SAFE_SYMBOL@3760: (line: string) => Promise<symbol | void>
```
