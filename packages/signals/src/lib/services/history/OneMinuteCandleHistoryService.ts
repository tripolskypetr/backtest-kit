...
export class OneMinuteCandleHistoryService {
  ...
  public getReport = async (symbol: string): Promise<string> => {
    log("oneMinuteCandleHistoryService getReport", { symbol });
