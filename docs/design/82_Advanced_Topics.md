...
For basic usage of the public API, see [Public API Reference](./09_Architecture.md). For service architecture patterns, see [Service Layer](./23_Component_Types.md). For signal lifecycle fundamentals, see [Signal Lifecycle](./46_Signal_Lifecycle.md).
