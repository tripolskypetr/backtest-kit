...
### __@WAIT_FOR_INIT_SYMBOL@2742

```ts
__@WAIT_FOR_INIT_SYMBOL@2742: (() => Promise<void>) & ISingleshotClearable
```
...
### __@WRITE_SAFE_SYMBOL@2743

```ts
__@WRITE_SAFE_SYMBOL@2743: (line: string) => Promise<symbol | void>
```
