...
### __@WAIT_FOR_INIT_SYMBOL@4441

```ts
__@WAIT_FOR_INIT_SYMBOL@4441: (() => Promise<void>) & ISingleshotClearable<() => Promise<void>>
```
...
### __@WRITE_SAFE_SYMBOL@4442

```ts
__@WRITE_SAFE_SYMBOL@4442: IWrappedQueuedFn<symbol | void, [line: string]>
```
