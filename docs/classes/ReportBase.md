...
### __@WAIT_FOR_INIT_SYMBOL$1@2676

```ts
__@WAIT_FOR_INIT_SYMBOL$1@2676: (() => Promise<void>) & ISingleshotClearable
```
...
### __@WRITE_SAFE_SYMBOL$1@2677

```ts
__@WRITE_SAFE_SYMBOL$1@2677: (line: string) => Promise<symbol | void>
```
