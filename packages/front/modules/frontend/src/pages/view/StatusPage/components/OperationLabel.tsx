        ...
        >
            <Stack direction="row" gap={1} sx={{ pointerEvents: "all" }}>
                <ActionButton
                    ...
                    onClick={async () => await commitOpenPendingEmitter.next()}
                    color="success"
                ...
                <ActionButton
                    ...
                    onClick={async () => await commitAverageBuyEmitter.next()}
                    color="warning"
                    sx={{ whiteSpace: "nowrap" }}
                >
                    Commit Averaging
                ...
                <ActionButton
                    ...
                    onClick={async () => await commitBreakevenEmitter.next()}
                    sx={{ whiteSpace: "nowrap" }}
                >
                    Commit Breakeven
                </ActionButton>
                ...
                <ActionButton
                    ...
                    onClick={async () => await commitClosePendingEmitter.next()}
                    sx={{ whiteSpace: "nowrap" }}
                    color="error"
                >
                    Close Position
