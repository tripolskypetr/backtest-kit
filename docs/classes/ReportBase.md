...
### __@WAIT_FOR_INIT_SYMBOL@4546

```ts
__@WAIT_FOR_INIT_SYMBOL@4546: (() => Promise<void>) & ISingleshotClearable<() => Promise<void>>
```
...
### __@WRITE_SAFE_SYMBOL@4547

```ts
__@WRITE_SAFE_SYMBOL@4547: IWrappedQueuedFn<symbol | void, [line: string]>
```
