 ...
 *
 * Лучший фактический результат движка среди всех версий боевой:
 * +19.55% за июнь, 10 сделок, 9 в плюсе, Sharpe 2.94, 0 стопов
 * (train-ожидание Sweep: +22.0%, Sharpe 3.66 — фильтр авторов
 * обучен на этом же июне).
