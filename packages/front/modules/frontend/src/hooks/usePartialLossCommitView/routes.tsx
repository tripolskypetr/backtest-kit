...
import PartialLossCommitView from "./view/PartialLossCommitView";
...
export const routes: IOutletModal[] = [
  {
    id: "partial_loss_commit",
    element: PartialLossCommitView,
    isActive: (pathname) => hasMatch(["/partial_loss_commit"], pathname),
  },
  {
    id: "candle_1m",
