...
### __@WAIT_FOR_INIT_SYMBOL$1@2939

```ts
__@WAIT_FOR_INIT_SYMBOL$1@2939: (() => Promise<void>) & ISingleshotClearable
```
...
### __@WRITE_SAFE_SYMBOL$1@2940

```ts
__@WRITE_SAFE_SYMBOL$1@2940: (line: string) => Promise<symbol | void>
```
