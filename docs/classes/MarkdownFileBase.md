...
### __@WAIT_FOR_INIT_SYMBOL@1950

```ts
__@WAIT_FOR_INIT_SYMBOL@1950: (() => Promise<void>) & ISingleshotClearable
```
...
### __@WRITE_SAFE_SYMBOL@1951

```ts
__@WRITE_SAFE_SYMBOL@1951: (line: string) => Promise<symbol | void>
```
