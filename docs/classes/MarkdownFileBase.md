...
### __@WAIT_FOR_INIT_SYMBOL@2201

```ts
__@WAIT_FOR_INIT_SYMBOL@2201: (() => Promise<void>) & ISingleshotClearable
```
...
### __@WRITE_SAFE_SYMBOL@2202

```ts
__@WRITE_SAFE_SYMBOL@2202: (line: string) => Promise<symbol | void>
```
