...
import AverageBuyCommitView from "./view/AverageBuyCommitView";
...
export const routes: IOutletModal[] = [
  {
    id: "average_buy_commit",
    element: AverageBuyCommitView,
    isActive: (pathname) => hasMatch(["/average_buy_commit"], pathname),
  },
  {
    id: "candle_1m",
