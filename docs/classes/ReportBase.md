...
### __@WAIT_FOR_INIT_SYMBOL$1@2814

```ts
__@WAIT_FOR_INIT_SYMBOL$1@2814: (() => Promise<void>) & ISingleshotClearable
```
...
### __@WRITE_SAFE_SYMBOL$1@2815

```ts
__@WRITE_SAFE_SYMBOL$1@2815: (line: string) => Promise<symbol | void>
```
