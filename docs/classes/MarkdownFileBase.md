...
### __@WAIT_FOR_INIT_SYMBOL@2229

```ts
__@WAIT_FOR_INIT_SYMBOL@2229: (() => Promise<void>) & ISingleshotClearable
```
...
### __@WRITE_SAFE_SYMBOL@2230

```ts
__@WRITE_SAFE_SYMBOL@2230: (line: string) => Promise<symbol | void>
```
